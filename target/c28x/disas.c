...
// Pop
INSN(POP_acc, POP, "ACC")
INSN(POP_ar1_ar0, POP, "AR1:AR0")
INSN(POP_ar3_ar2, POP, "AR3:AR2")
INSN(POP_ar5_ar4, POP, "AR5:AR4")
INSN(POP_ar1h_ar0h, POP, "AR1H:AR0H")
INSN(POP_dbgier, POP, "DBGIER")
INSN(POP_dp, POP, "DP")
INSN(POP_dp_st1, POP, "DP:ST1")
INSN(POP_ifr, POP, "IFR")
INSN(POP_loc16, POP, "%s", LOC(a->loc16))
INSN(POP_p, POP, "P")
INSN(POP_rpc, POP, "RPC")
INSN(POP_st0, POP, "ST0")
INSN(POP_st1, POP, "ST1")
INSN(POP_t_st0, POP, "T:ST0")
INSN(POP_xar0, POP, "XAR0")
INSN(POP_xar1, POP, "XAR1")
INSN(POP_xar2, POP, "XAR2")
INSN(POP_xar3, POP, "XAR3")
INSN(POP_xar4, POP, "XAR4")
INSN(POP_xar5, POP, "XAR5")
INSN(POP_xar6, POP, "XAR6")
INSN(POP_xar7, POP, "XAR7")
INSN(POP_xt, POP, "XT")

// Push
INSN(PUSH_acc, PUSH, "ACC")
INSN(PUSH_ar1_ar0, PUSH, "AR1:AR0")
INSN(PUSH_ar3_ar2, PUSH, "AR3:AR2")
INSN(PUSH_ar5_ar4, PUSH, "AR5:AR4")
INSN(PUSH_ar1h_ar0h, PUSH, "AR1H:AR0H")
INSN(PUSH_dbgier, PUSH, "DBGIER")
INSN(PUSH_dp, PUSH, "DP")
INSN(PUSH_dp_st1, PUSH, "DP:ST1")
INSN(PUSH_ifr, PUSH, "IFR")
INSN(PUSH_loc16, PUSH, "%s", LOC(a->loc16))
INSN(PUSH_p, PUSH, "P")
INSN(PUSH_rpc, PUSH, "RPC")
INSN(PUSH_st0, PUSH, "ST0")
INSN(PUSH_st1, PUSH, "ST1")
INSN(PUSH_t_st0, PUSH, "T:ST0")
INSN(PUSH_xar0, PUSH, "XAR0")
INSN(PUSH_xar1, PUSH, "XAR1")
INSN(PUSH_xar2, PUSH, "XAR2")
INSN(PUSH_xar3, PUSH, "XAR3")
INSN(PUSH_xar4, PUSH, "XAR4")
INSN(PUSH_xar5, PUSH, "XAR5")
INSN(PUSH_xar6, PUSH, "XAR6")
INSN(PUSH_xar7, PUSH, "XAR7")
INSN(PUSH_xt, PUSH, "XT")
